...
[`dashboard/` project](https://github.com/AndriiSydorenko1904/tay/tree/v0.9.8/dashboard),
but Phoenix, LiveView, and Plug are not dependencies of the core `tay` package.
See its
[README](https://github.com/AndriiSydorenko1904/tay/blob/v0.9.8/dashboard/README.md)
...
`arm64` as `ghcr.io/andriisydorenko1904/tay:0.9.8`. It includes the Erlang VM
and Tay runtime, so the host needs Docker (or another OCI runtime), not Elixir
or Erlang. Pull it directly with:

```sh
docker pull ghcr.io/andriisydorenko1904/tay:0.9.8
```
...
`ghcr.io/andriisydorenko1904/tay-dashboard:0.9.8`. It owns the Store, so never
