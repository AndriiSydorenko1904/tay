...
[`dashboard/` project](https://github.com/AndriiSydorenko1904/tay/tree/v0.9.6/dashboard),
but Phoenix, LiveView, and Plug are not dependencies of the core `tay` package.
See its
[README](https://github.com/AndriiSydorenko1904/tay/blob/v0.9.6/dashboard/README.md)
...
`arm64` as `ghcr.io/andriisydorenko1904/tay:0.9.6`. It includes the Erlang VM
...
`ghcr.io/andriisydorenko1904/tay-dashboard:0.9.6`. It owns the Store, so never
