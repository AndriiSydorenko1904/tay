...
```sh
docker pull ghcr.io/andriisydorenko1904/tay:0.11.0
```
...
```sh
docker pull ghcr.io/andriisydorenko1904/tay-dashboard:0.11.0
```
...
[`dashboard/` project](https://github.com/AndriiSydorenko1904/tay/tree/v0.11.0/dashboard),
but Phoenix, LiveView, and Plug are not dependencies of the core `tay` package.

See its
[README](https://github.com/AndriiSydorenko1904/tay/blob/v0.11.0/dashboard/README.md)
...
```text
ghcr.io/andriisydorenko1904/tay:0.11.0
```
...
```text
ghcr.io/andriisydorenko1904/tay-dashboard:0.11.0
```
